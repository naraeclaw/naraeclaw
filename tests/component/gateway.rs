...
//! verification) in isolation. The gateway module (`naraeclaw::gateway`) exposes
...
fn gateway_body_limit_is_reasonable() {
    assert_eq!(
        naraeclaw::gateway::MAX_BODY_SIZE,
        65_536,
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        naraeclaw::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        naraeclaw::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
