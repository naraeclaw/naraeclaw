...
use naraeclaw::providers::compatible::AuthStyle;
use naraeclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use naraeclaw::providers::compatible::OpenAiCompatibleProvider;
