...
use naraeclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use naraeclaw::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = naraeclaw::providers::ProviderRuntimeOptions::default();
