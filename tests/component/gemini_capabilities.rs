...
use naraeclaw::providers::create_provider_with_url;
use naraeclaw::providers::traits::Provider;
...
fn gemini_convert_tools_returns_prompt_guided() {
    use naraeclaw::providers::traits::ToolsPayload;
    use naraeclaw::tools::ToolSpec;
