...
:: ============================================================================
:: NaraeClaw Windows Setup Script
:: Simplifies building and installing NaraeClaw on Windows.
...
echo %BOLD%%BLUE%  NaraeClaw Windows Setup  v%VERSION%%RESET%
echo %BOLD%%BLUE%=========================================%RESET%
echo.
...
echo   3) Standard build    - Default + Matrix (~20 min)
...
:: ---- Standard build ----
:build_standard
set "FEATURES=--features channel-matrix"
set "BUILD_DESC=standard (Matrix)"
goto :do_build

:: ---- Full build ----
:build_full
set "FEATURES=--features channel-matrix,browser-native,hardware,rag-pdf,observability-otel"
...
:do_build
echo.
echo %BOLD%[3/5] Building NaraeClaw (%BUILD_DESC%)...%RESET%
echo   Target: %TARGET%
...
echo %BOLD%%GREEN%  NaraeClaw setup complete!%RESET%
echo %BOLD%%GREEN%=========================================%RESET%
echo.
echo   Next steps:
...
:show_help
echo.
echo NaraeClaw Windows Setup Script
echo.
...
echo   --standard    Build with Matrix
