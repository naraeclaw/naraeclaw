...
> 최종 목표: NaraeClaw 포크를 **텔레그램 중심·한국어 우선·경량·안전** 에이전트로 전환한다.
...
- **내용**: 채널과 provider feature set을 경량 기본값 중심으로 분리.
...
2. **C (한국어 UI)** — NaraeClaw 정체성. 기본 언어를 한국어로 전환하고, 남은 사용자 노출 영어/NaraeClaw 문구를 정리.
