...
const SNAPSHOT_HEADER: &str = "# 🧠 NaraeClaw Memory Snapshot\n\n\
    > Auto-generated by NaraeClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 NaraeClaw Memory Snapshot
...
I am NaraeClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 NaraeClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
