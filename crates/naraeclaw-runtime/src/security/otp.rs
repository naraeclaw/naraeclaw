...
use naraeclaw_config::schema::OtpConfig;
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(naraeclaw_dir);
...
pub fn secret_file_path(naraeclaw_dir: &Path) -> PathBuf {
    naraeclaw_dir.join(OTP_SECRET_FILE)
}
