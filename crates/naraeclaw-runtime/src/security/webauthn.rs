...
impl WebAuthnManager {
    ...
    /// will be stored (typically `~/.naraeclaw/`).
...
mod tests {
    ...
    fn start_registration_returns_valid_challenge() {
        ...
        assert_eq!(creation.rp.name, "NaraeClaw Test");
    ...
    fn default_config_has_sane_values() {
        ...
        assert_eq!(config.rp_name, "NaraeClaw");
    }
}
