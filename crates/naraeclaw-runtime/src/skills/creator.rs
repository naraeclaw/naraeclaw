...
pub fn extract_tool_calls_from_history(
    history: &[naraeclaw_providers::ChatMessage],
) -> Vec<ToolCallRecord> {
...
mod tests {
    ...
    use naraeclaw_memory::embeddings::{EmbeddingProvider, NoopEmbedding};
