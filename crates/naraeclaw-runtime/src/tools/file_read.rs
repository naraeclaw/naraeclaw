...
mod tests {
    ...
    mod e2e_helpers {
        ...
        use naraeclaw_config::schema::MemoryConfig;
        use naraeclaw_memory::{self, Memory};
        use naraeclaw_providers::{ChatMessage, ChatRequest, ChatResponse, Provider};
        ...
        pub fn make_memory() -> Arc<dyn Memory> {
            ...
            Arc::from(naraeclaw_memory::create_memory(&cfg, &std::env::temp_dir(), None).unwrap())
        }
    ...
    async fn e2e_agent_file_read_pdf_extraction() {
        ...
        use e2e_helpers::*;
        use naraeclaw_providers::{ChatResponse, Provider, ToolCall};
    ...
    ///
    /// Requires valid OAuth credentials in `~/.naraeclaw/`.
    ...
    async fn e2e_live_file_read_pdf() {
        ...
        use e2e_helpers::*;
        use naraeclaw_providers::openai_codex::OpenAiCodexProvider;
        use naraeclaw_providers::{Provider, ProviderRuntimeOptions};
