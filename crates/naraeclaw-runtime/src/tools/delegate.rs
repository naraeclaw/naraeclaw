...
use naraeclaw_config::schema::{DelegateAgentConfig, DelegateToolConfig};
use naraeclaw_memory::{Memory, NamespacedMemory};
...
impl DelegateTool {
    ...
    pub fn new_with_options(
        ...
        Self {
            ...
            multimodal_config: naraeclaw_config::schema::MultimodalConfig::default(),
    ...
    pub fn with_multimodal_config(
        mut self,
        config: naraeclaw_config::schema::MultimodalConfig,
    ) -> Self {
...
impl DelegateTool {
    ...
    async fn execute_sync(
        ...
        let provider: Box<dyn Provider> = match naraeclaw_providers::create_provider_with_options(
...
mod tests {
    ...
    use naraeclaw_providers::{ChatRequest, ChatResponse, ToolCall};
