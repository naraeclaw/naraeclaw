...
use naraeclaw_config::schema::{CronJobDecl, CronScheduleDecl};
...
///
/// Uses `sh -c <command>` (non-login shell). On Windows, NaraeClaw users
...
mod tests {
    ...
    async fn persist_job_result_delivery_stubbed_succeeds() {
        // Delivery is stubbed (moved to naraeclaw-channels orchestrator).
    ...
    // scan_and_redact_output tests moved to naraeclaw-channels orchestrator
