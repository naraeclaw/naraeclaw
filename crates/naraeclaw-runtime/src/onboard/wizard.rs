...
pub async fn run_wizard(force: bool, callbacks: WizardCallbacks) -> Result<Config> {
    ...
    let config = Config {
        ...
        backup: naraeclaw_config::schema::BackupConfig::default(),
        data_retention: naraeclaw_config::schema::DataRetentionConfig::default(),
        cloud_ops: naraeclaw_config::schema::CloudOpsConfig::default(),
        security: naraeclaw_config::schema::SecurityConfig::default(),
        security_ops: naraeclaw_config::schema::SecurityOpsConfig::default(),
        runtime: RuntimeConfig::default(),
        reliability: naraeclaw_config::schema::ReliabilityConfig::default(),
        scheduler: naraeclaw_config::schema::SchedulerConfig::default(),
        agent: naraeclaw_config::schema::AgentConfig::default(),
        pacing: naraeclaw_config::schema::PacingConfig::default(),
        skills: naraeclaw_config::schema::SkillsConfig::default(),
        pipeline: naraeclaw_config::schema::PipelineConfig::default(),
        ...
        browser_delegate: naraeclaw_tools::browser_delegate::BrowserDelegateConfig::default(),
        http_request: naraeclaw_config::schema::HttpRequestConfig::default(),
        ...
        web_fetch: naraeclaw_config::schema::WebFetchConfig::default(),
        link_enricher: naraeclaw_config::schema::LinkEnricherConfig::default(),
        text_browser: naraeclaw_config::schema::TextBrowserConfig::default(),
        web_search: naraeclaw_config::schema::WebSearchConfig::default(),
        google_workspace: naraeclaw_config::schema::GoogleWorkspaceConfig::default(),
        proxy: naraeclaw_config::schema::ProxyConfig::default(),
        identity: naraeclaw_config::schema::IdentityConfig::default(),
        cost: naraeclaw_config::schema::CostConfig::default(),
        delegate: naraeclaw_config::schema::DelegateToolConfig::default(),
        agents: std::collections::HashMap::new(),
        swarms: std::collections::HashMap::new(),
        hooks: naraeclaw_config::schema::HooksConfig::default(),
        query_classification: naraeclaw_config::schema::QueryClassificationConfig::default(),
        transcription: naraeclaw_config::schema::TranscriptionConfig::default(),
        tts: naraeclaw_config::schema::TtsConfig::default(),
        mcp: naraeclaw_config::schema::McpConfig::default(),
        nodes: naraeclaw_config::schema::NodesConfig::default(),
        workspace: naraeclaw_config::schema::WorkspaceConfig::default(),
        jira: naraeclaw_config::schema::JiraConfig::default(),
        node_transport: naraeclaw_config::schema::NodeTransportConfig::default(),
        knowledge: naraeclaw_config::schema::KnowledgeConfig::default(),
        linkedin: naraeclaw_config::schema::LinkedInConfig::default(),
        image_gen: naraeclaw_config::schema::ImageGenConfig::default(),
        plugins: naraeclaw_config::schema::PluginsConfig::default(),
        locale: None,
        verifiable_intent: naraeclaw_config::schema::VerifiableIntentConfig::default(),
        claude_code: naraeclaw_config::schema::ClaudeCodeConfig::default(),
        claude_code_runner: naraeclaw_config::schema::ClaudeCodeRunnerConfig::default(),
        codex_cli: naraeclaw_config::schema::CodexCliConfig::default(),
        gemini_cli: naraeclaw_config::schema::GeminiCliConfig::default(),
        opencode_cli: naraeclaw_config::schema::OpenCodeCliConfig::default(),
        sop: naraeclaw_config::schema::SopConfig::default(),
        shell_tool: naraeclaw_config::schema::ShellToolConfig::default(),
    };
...
fn resolve_quick_setup_dirs_with_home(home: &Path) -> (PathBuf, PathBuf) {
        ...
        std::env::var("NARAECLAW_WORKSPACE").or_else(|_| std::env::var("ZEROCLAW_WORKSPACE"))
    {
        ...
        if !trimmed.is_empty() {
            ...
            return naraeclaw_config::schema::resolve_config_dir_for_workspace(&PathBuf::from(
                expanded.as_ref(),
            ));
        }
    }
...
pub async fn run_models_refresh_all(config: &Config, force: bool) -> Result<()> {
    let mut targets: Vec<String> = naraeclaw_providers::list_providers()
        .into_iter()
...
async fn persist_workspace_selection(config_path: &Path) -> Result<()> {
    ...
    naraeclaw_config::schema::persist_active_workspace_config_dir(config_dir)
        .await
        .with_context(|| {
            format!(
...
async fn setup_workspace() -> Result<(PathBuf, PathBuf)> {
    let (default_config_dir, default_workspace_dir) =
        naraeclaw_config::schema::resolve_runtime_dirs_for_onboarding().await?;
    ...
    let (config_dir, workspace_dir) = if use_default {
        ...
        naraeclaw_config::schema::resolve_config_dir_for_workspace(&PathBuf::from(expanded))
    };
...
async fn setup_provider(workspace_dir: &Path) -> Result<(String, String, String, Option<String>)> {
    ...
    let api_key = if provider_name == "ollama" {
        ...
        if naraeclaw_providers::gemini::GeminiProvider::has_cli_credentials() {
            print_bullet(&format!(
    ...
    loop {
        ...
        match choice {
            ...
            ChannelMenuChoice::Nostr => {
                ...
                // Validate the key via callback (requires nostr-sdk in naraeclaw-channels)
...
#[allow(clippy::too_many_lines)]
fn setup_tunnel() -> Result<naraeclaw_config::schema::TunnelConfig> {
    use naraeclaw_config::schema::{
