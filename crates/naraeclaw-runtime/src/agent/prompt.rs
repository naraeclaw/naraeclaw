...
pub struct PromptContext<'a> {
    ...
    pub skills: &'a [Skill],
    pub skills_prompt_mode: naraeclaw_config::schema::SkillsPromptInjectionMode,
...
mod tests {
    ...
    fn identity_section_with_aieos_includes_workspace_files() {
        ...
        let identity_config = naraeclaw_config::schema::IdentityConfig {
            format: "aieos".into(),
            aieos_path: None,
    ...
    fn skills_section_compact_mode_omits_instructions_but_keeps_tools() {
        ...
        let ctx = PromptContext {
            ...
            tools: &tools,
            skills: &skills,
            skills_prompt_mode: naraeclaw_config::schema::SkillsPromptInjectionMode::Compact,
            identity_config: None,
            dispatcher_instructions: "",
            tool_descriptions: None,
            security_summary: None,
