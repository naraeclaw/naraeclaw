...
#[derive(Debug, Clone, Serialize, Deserialize, naraeclaw_macros::Configurable)]
#[cfg_attr(feature = "schema-export", derive(schemars::JsonSchema))]
#[prefix = "voice-wake"]
...
#[cfg(feature = "voice-wake")]
pub fn default_voice_wake_silence_timeout_ms() -> u32 {
    2000
}

#[cfg(feature = "voice-wake")]
pub fn default_voice_wake_energy_threshold() -> f32 {
    0.01
}

#[cfg(feature = "voice-wake")]
pub fn default_voice_wake_max_capture_secs() -> u32 {
    30
}
