...
/// Map tool name aliases from various LLM providers to NaraeClaw tool names.
...
/// to. This function encodes the mapping for known NaraeClaw tools.
...
pub fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. NaraeClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
