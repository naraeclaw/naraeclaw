...
const TIER_PROVIDERS: &[&[(&str, &str, &str)]] = &[
    ...
    &[
        ...
        ("Moonshot", "Kimi API (international endpoint)", "moonshot"),
        (
            "Moonshot Intl",
        ...
        ("Qwen", "DashScope international endpoint", "qwen"),
...
fn render_how_channels_work(frame: &mut Frame, area: Rect) {
    ...
    let lines = vec![
        ...
        Line::from(Span::styled(
            "  Matrix: open protocol; configure it in the channel settings.",
            theme::body_style(),
        )),
        Line::from(Span::styled(
