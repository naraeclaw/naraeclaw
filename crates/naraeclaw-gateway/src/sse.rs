...
pub struct BroadcastObserver {
    inner: Box<dyn naraeclaw_runtime::observability::Observer>,
...
impl BroadcastObserver {
    ...
    pub fn inner(&self) -> &dyn naraeclaw_runtime::observability::Observer {
        self.inner.as_ref()
    }
}

impl naraeclaw_runtime::observability::Observer for BroadcastObserver {
    fn record_event(&self, event: &naraeclaw_runtime::observability::ObserverEvent) {
        ...
        let json = match event {
            ...
            naraeclaw_runtime::observability::ObserverEvent::ToolCall {
                tool,
                duration,
                success,
            } => serde_json::json!({
            ...
            naraeclaw_runtime::observability::ObserverEvent::ToolCallStart { tool, .. } => {
                serde_json::json!({
            ...
            naraeclaw_runtime::observability::ObserverEvent::Error { component, message } => {
                serde_json::json!({
                    "type": "error",
                    "component": component,
                    "message": message,
            ...
            naraeclaw_runtime::observability::ObserverEvent::AgentStart { provider, model } => {
                serde_json::json!({
                    "type": "agent_start",
                    "provider": provider,
                    "model": model,
    ...
    fn record_metric(&self, metric: &naraeclaw_runtime::observability::traits::ObserverMetric) {
