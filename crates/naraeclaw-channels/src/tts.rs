...
use naraeclaw_config::schema::TtsConfig;
...
impl OpenAiTtsProvider {
    ...
    pub fn new(config: &naraeclaw_config::schema::OpenAiTtsConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl ElevenLabsTtsProvider {
    ...
    pub fn new(config: &naraeclaw_config::schema::ElevenLabsTtsConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl GoogleTtsProvider {
    ...
    pub fn new(config: &naraeclaw_config::schema::GoogleTtsConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl EdgeTtsProvider {
    ...
    pub fn new(config: &naraeclaw_config::schema::EdgeTtsConfig) -> Result<Self> {
...
mod tests {
    ...
    fn tts_manager_with_edge_provider() {
        ...
        config.edge = Some(naraeclaw_config::schema::EdgeTtsConfig {
    ...
    fn tts_manager_with_piper_provider() {
        ...
        config.piper = Some(naraeclaw_config::schema::PiperTtsConfig {
