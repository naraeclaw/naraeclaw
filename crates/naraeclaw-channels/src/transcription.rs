...
use naraeclaw_config::schema::TranscriptionConfig;
...
impl TranscriptionProvider for GroqProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = naraeclaw_config::schema::build_runtime_proxy_client("transcription.groq");
...
impl OpenAiWhisperProvider {
    pub fn from_config(config: &naraeclaw_config::schema::OpenAiSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for OpenAiWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = naraeclaw_config::schema::build_runtime_proxy_client("transcription.openai");
...
impl DeepgramProvider {
    pub fn from_config(config: &naraeclaw_config::schema::DeepgramSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for DeepgramProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = naraeclaw_config::schema::build_runtime_proxy_client("transcription.deepgram");
...
impl AssemblyAiProvider {
    pub fn from_config(config: &naraeclaw_config::schema::AssemblyAiSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for AssemblyAiProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            naraeclaw_config::schema::build_runtime_proxy_client("transcription.assemblyai");
...
impl GoogleSttProvider {
    pub fn from_config(config: &naraeclaw_config::schema::GoogleSttConfig) -> Result<Self> {
        let api_key = config
            .api_key
            .as_deref()
            .map(str::trim)
...
impl TranscriptionProvider for GoogleSttProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client = naraeclaw_config::schema::build_runtime_proxy_client("transcription.google");
...
impl LocalWhisperProvider {
    ...
    pub fn from_config(config: &naraeclaw_config::schema::LocalWhisperConfig) -> Result<Self> {
...
impl TranscriptionProvider for LocalWhisperProvider {
    ...
    async fn transcribe(&self, audio_data: &[u8], file_name: &str) -> Result<String> {
        ...
        let client =
            naraeclaw_config::schema::build_runtime_proxy_client("transcription.local_whisper");
...
mod tests {
    ...
    fn local_whisper_config(url: &str) -> naraeclaw_config::schema::LocalWhisperConfig {
        naraeclaw_config::schema::LocalWhisperConfig {
            url: url.to_string(),
