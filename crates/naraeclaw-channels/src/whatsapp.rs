...
mod tests {
    ...
    fn whatsapp_parse_valid_text_message() {
        ...
        assert_eq!(msgs[0].content, "Hello NaraeClaw!");
    ...
    fn make_group_mention_channel() -> WhatsAppChannel {
        ...
        .with_group_mention_patterns(vec!["@?NaraeClaw".into()])
    }
    ...
    fn make_dm_mention_channel() -> WhatsAppChannel {
        ...
        .with_dm_mention_patterns(vec!["@?NaraeClaw".into()])
    }
    ...
    fn whatsapp_compile_skips_invalid_patterns() {
        let patterns =
            WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into(), "[invalid".into()]);
    ...
    fn whatsapp_compile_skips_empty_patterns() {
        let patterns =
            WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into(), "  ".into()]);
        assert_eq!(patterns.len(), 1);
    }
    ...
    fn whatsapp_text_matches_at_name() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
    ...
    fn whatsapp_strip_at_name() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(
            WhatsAppChannel::strip_patterns(&pats, "@NaraeClaw what is the weather?"),
    ...
    fn whatsapp_strip_at_end() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(
            WhatsAppChannel::strip_patterns(&pats, "Help me @NaraeClaw"),
            Some("Help me".into())
        );
    }
    ...
    fn whatsapp_strip_mid_sentence() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(
            WhatsAppChannel::strip_patterns(&pats, "Hey @NaraeClaw how are you?"),
    ...
    fn whatsapp_strip_multiple_occurrences() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(
            WhatsAppChannel::strip_patterns(&pats, "@NaraeClaw hello @NaraeClaw"),
            Some("hello".into())
        );
    }
    ...
    fn whatsapp_strip_returns_none_when_only_mention() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(WhatsAppChannel::strip_patterns(&pats, "@NaraeClaw"), None);
    }
    ...
    fn whatsapp_strip_returns_none_for_whitespace_only() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(
            WhatsAppChannel::strip_patterns(&pats, "  @NaraeClaw  "),
            None
        );
    }
    ...
    fn whatsapp_strip_collapses_whitespace() {
        let pats = WhatsAppChannel::compile_mention_patterns(&["@?NaraeClaw".into()]);
        assert_eq!(
            WhatsAppChannel::strip_patterns(&pats, "@NaraeClaw   status   please"),
    ...
    fn whatsapp_group_mention_accepts_and_strips_in_group() {
        ...
        let payload = serde_json::json!({
            "entry": [{
                "changes": [{
                    "value": {
                        "messages": [group_msg("111", "1", "@NaraeClaw what is the weather?")]
                    }
                }]
            }]
        });
    ...
    fn whatsapp_group_mention_strips_from_group_content() {
        ...
        let payload = serde_json::json!({
            "entry": [{
                "changes": [{
                    "value": {
                        "messages": [group_msg("111", "1", "Hey @NaraeClaw tell me a joke")]
                    }
                }]
            }]
        });
    ...
    fn whatsapp_group_mention_drops_mention_only_group_message() {
        ...
        let payload = serde_json::json!({
            "entry": [{
                "changes": [{
                    "value": {
                        "messages": [group_msg("111", "1", "@NaraeClaw")]
                    }
                }]
            }]
        });
    ...
    fn whatsapp_group_mention_case_insensitive_group_match() {
        ...
        let payload = serde_json::json!({
            "entry": [{
                "changes": [{
                    "value": {
                        "messages": [group_msg("111", "1", "@naraeclaw status")]
                    }
                }]
            }]
        });
                ...
                "changes": [{
                    "value": {
                        "messages": [
                            ...
                            group_msg("222", "2", "@NaraeClaw help me"),
    ...
    fn whatsapp_group_mention_dm_not_stripped() {
        ...
        let payload = serde_json::json!({
            "entry": [{
                "changes": [{
                    "value": {
                        "messages": [dm_msg("111", "1", "@NaraeClaw what is the weather?")]
                    }
                }]
            }]
        });
        ...
        assert_eq!(msgs.len(), 1);
        assert_eq!(
            msgs[0].content, "@NaraeClaw what is the weather?",
