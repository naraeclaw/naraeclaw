...
pub struct DiscordChannel {
    ...
    stream_mode: naraeclaw_config::schema::StreamMode,
...
impl Channel for DiscordChannel {
    ...
    async fn send(&self, message: &SendMessage) -> anyhow::Result<()> {
        ...
        if self.stream_mode == naraeclaw_config::schema::StreamMode::MultiMessage {
    ...
    async fn listen(&self, tx: tokio::sync::mpsc::Sender<ChannelMessage>) -> anyhow::Result<()> {
        ...
        let (ws_stream, _) = naraeclaw_config::schema::ws_connect_with_proxy(
            &ws_url,
            "channel.discord",
            self.proxy_url.as_deref(),
        )
        ...
        let watchdog = if self.stall_timeout_secs > 0 {
            Some(naraeclaw_infra::stall_watchdog::StallWatchdog::new(
    ...
    fn supports_draft_updates(&self) -> bool {
        self.stream_mode != naraeclaw_config::schema::StreamMode::Off
    }

    fn supports_multi_message_streaming(&self) -> bool {
        self.stream_mode == naraeclaw_config::schema::StreamMode::MultiMessage
    }
