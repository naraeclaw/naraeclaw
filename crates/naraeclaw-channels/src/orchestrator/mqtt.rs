...
use naraeclaw_config::schema::MqttConfig;
use naraeclaw_runtime::sop::audit::SopAuditLogger;
use naraeclaw_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use naraeclaw_runtime::sop::engine::{SopEngine, now_iso8601};
use naraeclaw_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    naraeclaw_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                naraeclaw_runtime::health::mark_component_error("mqtt", e.to_string());
