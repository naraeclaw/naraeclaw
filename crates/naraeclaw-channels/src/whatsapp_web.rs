...
//! session_path = "~/.naraeclaw/whatsapp-session.db"  # Required for Web mode
...
/// ```toml
/// [channels_config.whatsapp]
/// session_path = "~/.naraeclaw/whatsapp-session.db"
...
pub struct WhatsAppWebChannel {
    ...
    mode: naraeclaw_config::schema::WhatsAppWebMode,
    /// DM policy when mode = personal
    dm_policy: naraeclaw_config::schema::WhatsAppChatPolicy,
    /// Group policy when mode = personal
    group_policy: naraeclaw_config::schema::WhatsAppChatPolicy,
...
impl WhatsAppWebChannel {
    ...
    async fn try_transcribe_voice_note(
        ...
        transcription_config: Option<&naraeclaw_config::schema::TranscriptionConfig>,
                    ...
                    async move {
                        match event {
                            Event::Message(msg, info) => {
                                ...
                                if wa_mode == naraeclaw_config::schema::WhatsAppWebMode::Personal {
                                    ...
                                    if is_self_chat {
                                        ...
                                        match wa_group_policy {
                                            naraeclaw_config::schema::WhatsAppChatPolicy::Ignore => {
                                                tracing::debug!(
                                                    "WhatsApp Web: ignoring group message (group_policy=ignore)"
                                                );
                                                return;
                                            }
                                            naraeclaw_config::schema::WhatsAppChatPolicy::All => {
                                                // allow unconditionally
                                            }
                                            naraeclaw_config::schema::WhatsAppChatPolicy::Allowlist => {
...
impl WhatsAppWebChannel {
    pub fn new(
        ...
        _mention_only: bool,
        _mode: naraeclaw_config::schema::WhatsAppWebMode,
        _dm_policy: naraeclaw_config::schema::WhatsAppChatPolicy,
        _group_policy: naraeclaw_config::schema::WhatsAppChatPolicy,
    ...
    pub fn with_transcription(
        self,
        _config: naraeclaw_config::schema::TranscriptionConfig,
    ) -> Self {
        self
    }

    pub fn with_tts(self, _config: naraeclaw_config::schema::TtsConfig) -> Self {
        self
    }
}
...
mod tests {
    ...
    fn make_channel() -> WhatsAppWebChannel {
        WhatsAppWebChannel::new(
            ...
            vec!["+1234567890".into()],
            false,
            naraeclaw_config::schema::WhatsAppWebMode::default(),
            naraeclaw_config::schema::WhatsAppChatPolicy::default(),
            naraeclaw_config::schema::WhatsAppChatPolicy::default(),
            false,
        )
    }
