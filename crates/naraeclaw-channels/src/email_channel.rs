...
pub use naraeclaw_config::scattered_types::EmailConfig;
...
impl EmailChannel {
    ...
    fn extract_attachments(
    ...
    ) -> Vec<naraeclaw_api::media::MediaAttachment> {
        ...
        for part in parsed.attachments() {
            ...
            attachments.push(naraeclaw_api::media::MediaAttachment {
                file_name,
                data,
                mime_type: mime_str,
            });
...
struct ParsedEmail {
    ...
    content: String,
    timestamp: u64,
    attachments: Vec<naraeclaw_api::media::MediaAttachment>,
}
...
mod tests {
    ...
    fn email_config_deserialize_with_defaults() {
        ...
        assert_eq!(config.default_subject, "NaraeClaw Message"); // default
    }
