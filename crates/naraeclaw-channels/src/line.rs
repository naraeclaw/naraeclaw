...
use naraeclaw_config::schema::{LineDmPolicy, LineGroupPolicy};
...
impl LineChannel {
    ...
    pub fn new(
        ...
        Self {
            ...
            client: naraeclaw_config::schema::build_channel_proxy_client("channel.line", None),
    ...
    /// Construct a `LineChannel` directly from a [`naraeclaw_config::schema::LineConfig`].
    ///
    /// Keeps construction logic inside the channel crate rather than duplicating it across orchestrator call sites.
    pub fn from_config(config: &naraeclaw_config::schema::LineConfig) -> Self {
        Self::new(
    ...
    pub fn with_proxy_url(mut self, proxy_url: Option<String>) -> Self {
        self.client = naraeclaw_config::schema::build_channel_proxy_client(
            "channel.line",
            proxy_url.as_deref(),
        );
        self
...
mod tests {
    ...
    async fn with_transcription_disabled_config_is_noop() {
        ...
        .with_transcription(naraeclaw_config::schema::TranscriptionConfig {
            enabled: false,
            ..Default::default()
        });
    ...
    async fn webhook_audio_transcribed_and_forwarded() {
        ...
        let transcription_config = naraeclaw_config::schema::TranscriptionConfig {
            enabled: true,
            ...
            assemblyai: None,
            google: None,
            local_whisper: Some(naraeclaw_config::schema::LocalWhisperConfig {
