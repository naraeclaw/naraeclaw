...
use naraeclaw_config::schema::FirecrawlConfig;
use serde_json::json;
use std::sync::Arc;
...
impl Tool for WebFetchTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let builder = reqwest::Client::builder()
            ...
            .user_agent("NaraeClaw/0.1 (web_fetch)");
        let builder =
            naraeclaw_config::schema::apply_runtime_proxy_to_builder(builder, "tool.web_fetch");
...
mod tests {
    ...
    fn firecrawl_config_defaults() {
        ...
        assert_eq!(cfg.mode, naraeclaw_config::schema::FirecrawlMode::Scrape);
    }
    ...
    fn firecrawl_config_deserializes_from_toml() {
        ...
        assert_eq!(cfg.mode, naraeclaw_config::schema::FirecrawlMode::Crawl);
    }
    ...
    fn web_fetch_config_with_firecrawl_section() {
        use naraeclaw_config::schema::WebFetchConfig;
        let toml_str = r#"
            enabled = true
            [firecrawl]
            enabled = true
