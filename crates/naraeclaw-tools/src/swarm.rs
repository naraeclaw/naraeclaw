...
use naraeclaw_api::provider::Provider;
...
use naraeclaw_config::schema::{DelegateAgentConfig, SwarmConfig, SwarmStrategy};
use serde_json::json;
...
impl SwarmTool {
    ...
    fn create_provider_for_agent(
        ...
        naraeclaw_providers::create_provider_with_options(
    ...
    async fn execute_parallel(
        ...
        for agent_name in &swarm_config.agents {
            ...
            let provider = match naraeclaw_providers::create_provider_with_options(
                &agent_config.provider,
                credential.as_deref(),
                &self.provider_runtime_options,
            ) {
