...
use naraeclaw_config::schema::ClaudeCodeRunnerConfig;
...
/// execution events back to NaraeClaw's gateway endpoint, enabling live Slack
...
pub struct ClaudeCodeRunnerTool {
    ...
    /// Base URL of the NaraeClaw gateway (e.g. "http://localhost:3000").
    gateway_url: String,
}
