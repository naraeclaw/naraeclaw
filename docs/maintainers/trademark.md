...
The following names identify this fork:
...
originally developed by ZeroClaw Labs.
...
Forks and redistributions should retain:

- `LICENSE-MIT`
- `LICENSE-APACHE`
- `NOTICE`
- relevant commit history or other attribution metadata
...
- "official ZeroClaw"
- "ZeroClaw by NaraeClaw"
- names, package metadata, or domains that make this fork look like the upstream
  official project

## Relationship to Software Licenses

This policy is separate from the MIT and Apache 2.0 software licenses. The
software licenses govern source code use. This document only covers project
identity, attribution, and avoiding user confusion.
