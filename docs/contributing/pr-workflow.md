...
- If identity-like wording appears in tests/examples, it is normalized to NaraeClaw/project-native labels.
...
- Confirm any required identity-like wording uses NaraeClaw/project-native terminology.
