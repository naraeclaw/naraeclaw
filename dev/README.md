# NaraeClaw Development Environment

A fully containerized development sandbox for NaraeClaw agents. This environment allows you to develop, test, and debug the agent in isolation without modifying your host system.
...
**Note:** This removes `target/.naraeclaw` (config/DB) but leaves the `playground/` directory intact. To fully wipe workspace data, manually delete `playground/`.
